...
if(isset($_POST["submit"])){
    ...
    if($_POST["status"]== 1){
        $post_slt = mysqli_query($con,"SELECT * FROM blog_vaneskha_post_comment WHERE post_id = '$post' AND status = 1 ");
        $cur_cmt = mysqli_num_rows($post_slt);
        
        $cur_stat = $cur_cmt+1;
        mysqli_query($con,"UPDATE blog_vaneskha_post SET comment = '$cur_stat' WHERE id = '$post'");
        mysqli_query($con,"INSERT INTO blog_vaneskha_post_comment VALUES ('','$post','$name','$reply','$status','$date')");
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!--<td class="center"><a href="index.php?comment-update=<?php echo $co_row["id"]?> " class="btn btn-primary btn-xs" type="button">Update</a></td>-->
                                <td class="center"><a href="index.php?comment-delete=<?php echo $co_row["id"]?> " class="btn btn-primary btn-xs" type="button">Delete</a></td>
                            </tr>
                                <?php }?>
                            <?php }?>
                        </tbody>
